...
5. The functionality to buy credits is not yet developed as it involves roles and authorization, so you will have to update the balance for your user and add credits manually, the structure of the table is very simple, you only need to update the credits field with the number of credits you want, 30 credits will be enough for testing.
